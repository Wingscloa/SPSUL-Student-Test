...
{
    /// <summary>
    /// API controller pro generování PDF dokumentů pomocí knihovny QuestPDF.
    ///
    /// Endpointy:
    ///   GET /api/pdf/tests    – export seznamu testů do PDF
    ///   GET /api/pdf/students – export seznamu studentů do PDF
    ///   GET /api/pdf/teachers – export seznamu učitelů do PDF
    ///   GET /api/pdf/classes  – export seznamu tříd do PDF
    ///
    /// Jak funguje:
    ///   PdfService (QuestPDF) přijme data a vygeneruje PDF binar.ní soubor.
    ///   Response je vrácena jako application/pdf s Content-Disposition: attachment.
    ///   Prohlížeč automaticky spustí stažení souboru.
    /// </summary>
    [LoginRequired]
