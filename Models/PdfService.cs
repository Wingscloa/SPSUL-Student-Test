...
namespace SPSUL.Models
{
    public class PdfService
    {
        ...
        private void ComposeHeader(IContainer container)
        {
            ...
            container.Row(row =>
            {
                ...
                row.RelativeItem().AlignMiddle().AlignRight().Column(col =>
                {
                    ...
                    col.Item().Text("Informační technologie").FontSize(7).FontColor("#333");
        ...
        {
            return CreateDocument($"Přihlašovací kódy – {test.Name}", content =>
            {
                content.Column(col =>
                {
                            ...
                            for (int c = 0; c < 3; c++)
                            {
                                ...
                                if (c < chunk.Count)
                                {
                                    ...
                                    row.RelativeItem().Border(1).BorderColor("#333").Padding(8).Column(card =>
                                    {
                                        ...
                                        card.Item().AlignCenter().Text("Zadejte tento kód na přihlašovací stránce testu")
        ...
        {
            return CreateDocument("Seznam studentů", content =>
            {
                content.Table(table =>
                {
        ...
        {
            return CreateDocument("Seznam učitelů", content =>
            {
                content.Table(table =>
                {
                    table.ColumnsDefinition(cols =>
        ...
        {
            return CreateDocument("Seznam tříd", content =>
            {
                content.Table(table =>
                {
                    table.ColumnsDefinition(cols =>
        ...
        {
            return CreateDocument("Seznam testů", content =>
            {
                content.Table(table =>
                {
                    table.ColumnsDefinition(cols =>
            ...
            return CreateDocument("Seznam otázek", content =>
            {
                content.Table(table =>
                {
                    ...
                    table.Header(header =>
                    {
                        HeaderCell(header, "#");
                        HeaderCell(header, "Název");
                        HeaderCell(header, "Tvůrce");
                        HeaderCell(header, "Typ otázky");
                        HeaderCell(header, "Předmět");
                        HeaderCell(header, "Stav");
                    });
        ...
        {
            return CreateDocument("Výsledky testů", content =>
            {
                content.Table(table =>
                {
                    table.ColumnsDefinition(cols =>
                    ...
                    table.Header(header =>
                    {
                        ...
                        HeaderCell(header, "Začal");
                        HeaderCell(header, "Dokončil");
                        HeaderCell(header, "Úspěšnost");
                    ...
                    foreach (var r in results)
                    {
                        ...
                        DataCell(table, r.Absolvoval ? "Prospěl" : "Neprospěl");
                        idx++;
                    }
                });
            }).GeneratePdf();
